...
The dependency-updater delegates OpenAPI Generator plugin updates to the specialized `openapi-generator-plugin-updater` skill for
intelligent compatibility management.
